...
fig1.savefig('pic1.png',dpi =300)
fig2.savefig('pic2.png',dpi =300)
st.markdown('---')
...
fig3.savefig('pic3.png',dpi =300)
fig4.savefig('pic4.png',dpi =300)
fig5.savefig('pic5.png',dpi =300)
...
fig6.savefig('pic6.png',dpi =300)
fig7.savefig('pic7.png',dpi =300)
fig8.savefig('pic8.png',dpi =300)
#college enrollment 
